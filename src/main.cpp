...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Warriors beat Pacers at home";
        CTransaction txNew;
        txNew.nTime = 1420839900;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe7aef71d29107f8ec5531a7a6b89fcf5d1748ab8db0f87e061ad7f735555ba84"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xc3, 0x88, 0x22, 0xd2 };
